...
public class CookingLasagne extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_lasagne);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 12) {
            ...
            Intent intent = new Intent(this, lazanq_gotovikori.class);
