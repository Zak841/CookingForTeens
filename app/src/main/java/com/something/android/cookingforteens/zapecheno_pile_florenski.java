...
public class zapecheno_pile_florenski extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zapecheno_pile_florenski);
    }
    ...
    public void cookingovesenakasha (View view) {
        ...
        Intent intent = new Intent(this, CookingZapechenoPile.class);
