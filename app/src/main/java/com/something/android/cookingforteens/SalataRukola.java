...
public class SalataRukola extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_salata_rukola2);
    }
    int RightAnswers = 0;
    ...
    public void checkQestion (View view) {
        ...
        CheckQeustions(answer, answer22, answer33, answer44);
        CheckTrueAnswers(RightAnswers);
    }
    //тук става самата проверка
    private void CheckQeustions (boolean answer, boolean answer2, boolean answer3, boolean answer4) {
        if (answer) {
            RightAnswers += 1;
        }
        if (answer2) {
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 4) {
            ...
            Intent intent = new Intent(this, salata_rukola.class);
