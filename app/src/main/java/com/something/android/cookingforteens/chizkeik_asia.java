...
public class chizkeik_asia extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chizkeik_asia);
    }
    ...
    public void cookingovesenakasha (View view) {
        ...
        Intent intent = new Intent(this, CookingChizkeikAsia.class);
