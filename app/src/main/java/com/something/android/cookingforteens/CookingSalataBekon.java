...
public class CookingSalataBekon extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_salata_bekon);
    }
    int RightAnswers = 0;
    ...
    public void checkQestion (View view) {
        ...
        CheckBox answer23 = (CheckBox) findViewById(R.id.answer23);
        boolean answer2323 = answer23.isChecked();
        CheckBox answer24 = (CheckBox) findViewById(R.id.answer24);
        boolean answer2424 = answer24.isChecked();
        CheckBox answer25 = (CheckBox) findViewById(R.id.answer25);
        boolean answer2525 = answer25.isChecked();
        CheckQeustions(answer, answer22, answer33, answer44, answer55, answer66, answer77, answer88, answer99, answer1010, answer1111, answer1212, answer1313, answer1414, answer1515, answer1616, answer1717, answer1818, answer1919, answer2020, answer2121, answer2222, answer2323, answer2424, answer2525);
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 25) {
            ...
            Intent intent = new Intent(this, salata_bekon.class);
