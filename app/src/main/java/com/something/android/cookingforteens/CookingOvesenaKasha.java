...
public class CookingOvesenaKasha extends AppCompatActivity {
    int RightAnswers = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cookking_ovesena_kasha);
    }
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 9) {
            ...
            Intent intent = new Intent(this, ovesena_kasha.class);
