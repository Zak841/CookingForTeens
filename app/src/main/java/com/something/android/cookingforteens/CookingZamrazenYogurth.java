...
public class CookingZamrazenYogurth extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_zamrazen_yogurth);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 3) {
            ...
            Intent intent = new Intent(this, zamrazen_yogurth.class);
