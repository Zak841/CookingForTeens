...
public class CookingAvtentichnoPile extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_avtentichno_pile);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 11) {
            ...
            Intent intent = new Intent(this, avtentichno_pile.class);
