...
public class aziatsko_zele extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aziatsko_zele);
    }
    ...
    public void cookingovesenakasha (View view) {
        ...
        Intent intent = new Intent(this, CookingAziatskoZele.class);
