...
public class CookingSupasAromatnaIztok extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_supas_aromatna_iztok);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 8) {
            ...
            Intent intent = new Intent(this, supas_aromat_naiztok.class);
