...
public class CookingShokoladovoSushi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_shokoladovo_sushi);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 19) {
            ...
            Intent intent = new Intent(this, shokoladovo_sushi.class);
