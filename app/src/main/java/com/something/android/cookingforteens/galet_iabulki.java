...
public class galet_iabulki extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_galet_iabulki);
    }
    ...
    public void cookingovesenakasha (View view) {
        ...
        Intent intent = new Intent(this, CookingGaletIabulki.class);
