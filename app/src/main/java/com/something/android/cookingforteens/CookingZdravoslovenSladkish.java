...
public class CookingZdravoslovenSladkish extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_zdravosloven_sladkish);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 5) {
            ...
            Intent intent = new Intent(this, zdravosloven_sladkish.class);
