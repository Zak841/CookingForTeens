...
public class CookingPileZelenchuci extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_pile_zelenchuci);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 7) {
            ...
            Intent intent = new Intent(this, pile_zelenchuci.class);
