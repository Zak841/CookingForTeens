...
public class teriaki_shishcheta extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teriaki_shishcheta);
    }
    ...
    public void cookingovesenakasha (View view) {
        ...
        Intent intent = new Intent(this, CookingTeriakiShishcheta.class);
