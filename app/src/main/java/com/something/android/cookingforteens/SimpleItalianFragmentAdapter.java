...
public class SimpleItalianFragmentAdapter extends FragmentPagerAdapter {
    public SimpleItalianFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new ItalianStartCourseFragment();
        } else if (position == 1) {
            return new ItalianMiddleCourseFragment();
        } else {
            return new ItalianEndCourseFragment();
        }
    }
