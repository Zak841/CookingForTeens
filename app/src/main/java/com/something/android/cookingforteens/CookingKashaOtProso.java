...
public class CookingKashaOtProso extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_kasha_ot_proso);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 7) {
            ...
            Intent intent = new Intent(this, kasha_ot_proso.class);
