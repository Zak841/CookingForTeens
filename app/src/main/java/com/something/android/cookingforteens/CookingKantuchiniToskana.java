...
public class CookingKantuchiniToskana extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_kantuchini_toskana);
    }
    int RightAnswers = 0;
    ...
    public void checkQestion (View view) {
        ...
        CheckQeustions(answer, answer22, answer33, answer44, answer55, answer66, answer77, answer88, answer99, answer1010);

        CheckTrueAnswers(RightAnswers);
    }
    //тук става самата проверка
    private void CheckQeustions (boolean answer, boolean answer2, boolean answer3, boolean answer4, boolean answer5, boolean answer6, boolean answer7, boolean answer8, boolean answer9, boolean answer10) {
        if (answer) {
            RightAnswers += 1;
        }
        if (answer2) {
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 10) {
            ...
            Intent intent = new Intent(this, kantuchini_toskana.class);
