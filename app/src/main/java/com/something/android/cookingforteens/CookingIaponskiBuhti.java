...
public class CookingIaponskiBuhti extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_iaponski_buhti);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 10) {
            ...
            Intent intent = new Intent(this, iaponski_buhtichki.class);
