...
public class CookingTeriakiShishcheta extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cooking_teriaki_shishcheta);
    }
    int RightAnswers = 0;
    ...
    private void CheckTrueAnswers (int answer) {
        ...
        if (answer >= 7) {
            ...
            Intent intent = new Intent(this, teriaki_shishcheta.class);
